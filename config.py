# ⚠️ Bu faylni hech kimga yubormang / GitHub'ga ochiq qo'ymang.
# Bot tokenini @BotFather orqali /revoke qilib, yangisini shu yerga qo'ying.
...
# --- Hamyon API sozlamalari (rasmdan) ---
